...
namespace ElementsSDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AWSAccountPartialUpdate")]
    public partial class AWSAccountPartialUpdate : IEquatable<AWSAccountPartialUpdate>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AWSAccountPartialUpdate" /> class.
        /// </summary>
        ...
        public AWSAccountPartialUpdate(string name = default(string), string accessKeyId = default(string), string secretAccessKey = default(string), string endpointUrl = default(string), DefaultRegionEnum? defaultRegion = default(DefaultRegionEnum?))
        {
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AWSAccountPartialUpdate {\n");
        ...
        {
            return this.Equals(input as AWSAccountPartialUpdate);
        }

        /// <summary>
        /// Returns true if AWSAccountPartialUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of AWSAccountPartialUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AWSAccountPartialUpdate input)
        {
            if (input == null)
                return false;
