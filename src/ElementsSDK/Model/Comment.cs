...
namespace ElementsSDK.Model
{
    ...
    public partial class Comment : IEquatable<Comment>
    {
        ...
        /// <param name="fullAsset">fullAsset.</param>
        ...
        public Comment(ElementsUserMiniReference assignee = default(ElementsUserMiniReference), ElementsUserMiniReference user = default(ElementsUserMiniReference), Dictionary<string, string> drawing = default(Dictionary<string, string>), List<TagReference> tags = default(List<TagReference>), Asset fullAsset = default(Asset), string text = default(string), decimal? time = default(decimal?), bool isCloud = default(bool), bool resolved = default(bool), DateTime? resolvedDate = default(DateTime?), int asset = default(int), int? root = default(int?), int? parent = default(int?))
        {
            this.Asset = asset;
        ...
        /// <summary>
        /// Gets or Sets FullAsset
        /// </summary>
        [DataMember(Name = "full_asset", EmitDefaultValue = false)]
        public Asset FullAsset { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FullAsset: ").Append(FullAsset).Append("\n");
        ...
        public bool Equals(Comment input)
        {
            ...
            return 
                ...
                (
                    this.FullAsset == input.FullAsset ||
                    (this.FullAsset != null &&
                    this.FullAsset.Equals(input.FullAsset))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FullAsset != null)
                    hashCode = hashCode * 59 + this.FullAsset.GetHashCode();
                if (this.SyncId != null)
