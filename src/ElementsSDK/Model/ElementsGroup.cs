...
namespace ElementsSDK.Model
{
    ...
    /// ElementsGroup
    /// </summary>
    [DataContract(Name = "ElementsGroup")]
    public partial class ElementsGroup : IEquatable<ElementsGroup>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ElementsGroup" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ElementsGroup() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ElementsGroup" /> class.
        /// </summary>
        ...
        public ElementsGroup(List<string> permissions = default(List<string>), string name = default(string), string ldapDn = default(string), string unixGroupname = default(string), int? gid = default(int?), string ancillaryPath = default(string), bool ancillaryPathReadOnly = default(bool), int? ldap = default(int?), List<int> members = default(List<int>))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for ElementsGroup and cannot be null");
            // to ensure "members" is required (not null)
            this.Members = members ?? throw new ArgumentNullException("members is a required property for ElementsGroup and cannot be null");
        ...
        {
            return this.Equals(input as ElementsGroup);
        }

        /// <summary>
        /// Returns true if ElementsGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of ElementsGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ElementsGroup input)
        {
            if (input == null)
                return false;
