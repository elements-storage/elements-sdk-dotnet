...
namespace ElementsSDK.Model
{
    ...
    public partial class InlineResponse2004 : IEquatable<InlineResponse2004>
    {
        ...
        public InlineResponse2004(int count = default(int), string next = default(string), string previous = default(string), List<TaskType> results = default(List<TaskType>))
        {
            this.Count = count;
            // to ensure "results" is required (not null)
            this.Results = results ?? throw new ArgumentNullException("results is a required property for InlineResponse2004 and cannot be null");
            this.Next = next;
        ...
        public List<TaskType> Results { get; set; }
