...
namespace ElementsSDK.Model
{
    ...
    /// Tape
    /// </summary>
    [DataContract(Name = "Tape")]
    public partial class Tape : IEquatable<Tape>
    {
        /// <summary>
        /// Defines Lto
        /// </summary>
        ...
        public Tape(string name = default(string), string uuid = default(string), int generation = default(int), string customA = default(string), string customB = default(string), string customC = default(string), string customD = default(string), int? freeSpace = default(int?), int loadCounter = default(int), int errorCounter = default(int), string errorReason = default(string), bool active = default(bool), LtoEnum? lto = default(LtoEnum?), int? group = default(int?))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for Tape and cannot be null");
            this.Uuid = uuid;
