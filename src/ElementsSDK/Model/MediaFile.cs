...
namespace ElementsSDK.Model
{
    ...
    public partial class MediaFile : IEquatable<MediaFile>
    {
        ...
        public MediaFile(VolumeMini volume = default(VolumeMini), Dictionary<string, string> info = default(Dictionary<string, string>), Dictionary<string, string> customFields = default(Dictionary<string, string>), MediaRootPermission resolvedPermission = default(MediaRootPermission), MediaRootMini root = default(MediaRootMini), ElementsUserMini modifiedBy = default(ElementsUserMini), int? totalFiles = default(int?), bool needsRescan = default(bool), List<int> bookmarkedBy = default(List<int>))
        {
            this.Volume = volume;
            this.Info = info;
        ...
        {
            return this.Equals(input as MediaFile);
        }

        /// <summary>
        /// Returns true if MediaFile instances are equal
        /// </summary>
        /// <param name="input">Instance of MediaFile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MediaFile input)
        {
            if (input == null)
                return false;
