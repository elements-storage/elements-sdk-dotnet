...
namespace ElementsSDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WorkspacePartialUpdate")]
    public partial class WorkspacePartialUpdate : IEquatable<WorkspacePartialUpdate>
    {
        /// <summary>
        /// Defines MacProtocol
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkspacePartialUpdate" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkspacePartialUpdate {\n");
        ...
        {
            return this.Equals(input as WorkspacePartialUpdate);
        }

        /// <summary>
        /// Returns true if WorkspacePartialUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkspacePartialUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkspacePartialUpdate input)
        {
            if (input == null)
                return false;
