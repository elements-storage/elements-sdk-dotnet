...
namespace ElementsSDK.Model
{
    ...
    public partial class InlineResponse2003 : IEquatable<InlineResponse2003>
    {
        ...
        public InlineResponse2003(int count = default(int), string next = default(string), string previous = default(string), List<Queue> results = default(List<Queue>))
        {
            this.Count = count;
            // to ensure "results" is required (not null)
            this.Results = results ?? throw new ArgumentNullException("results is a required property for InlineResponse2003 and cannot be null");
            this.Next = next;
        ...
        public List<Queue> Results { get; set; }
