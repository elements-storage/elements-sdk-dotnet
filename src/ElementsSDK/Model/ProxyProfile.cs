...
namespace ElementsSDK.Model
{
    ...
    /// ProxyProfile
    /// </summary>
    [DataContract(Name = "ProxyProfile")]
    public partial class ProxyProfile : IEquatable<ProxyProfile>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyProfile" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProxyProfile() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyProfile" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ProxyProfile);
        }

        /// <summary>
        /// Returns true if ProxyProfile instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyProfile input)
        {
            if (input == null)
                return false;
