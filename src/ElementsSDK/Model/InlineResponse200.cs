...
namespace ElementsSDK.Model
{
    ...
    public partial class InlineResponse200 : IEquatable<InlineResponse200>
    {
        ...
        public InlineResponse200(int count = default(int), string next = default(string), string previous = default(string), List<ClickGallery> results = default(List<ClickGallery>))
        {
            this.Count = count;
            // to ensure "results" is required (not null)
            this.Results = results ?? throw new ArgumentNullException("results is a required property for InlineResponse200 and cannot be null");
            this.Next = next;
        ...
        public List<ClickGallery> Results { get; set; }
