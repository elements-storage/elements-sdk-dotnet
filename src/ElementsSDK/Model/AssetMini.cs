...
namespace ElementsSDK.Model
{
    ...
    /// AssetMini
    /// </summary>
    [DataContract(Name = "AssetMini")]
    public partial class AssetMini : IEquatable<AssetMini>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetMini" /> class.
        /// </summary>
        /// <param name="defaultProxy">defaultProxy.</param>
        public AssetMini(Proxy defaultProxy = default(Proxy))
        {
        ...
        {
            return this.Equals(input as AssetMini);
        }

        /// <summary>
        /// Returns true if AssetMini instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetMini to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetMini input)
        {
            if (input == null)
                return false;
