...
namespace ElementsSDK.Model
{
    ...
    public partial class InlineResponse2002 : IEquatable<InlineResponse2002>
    {
        ...
        public InlineResponse2002(int count = default(int), string next = default(string), string previous = default(string), List<Event> results = default(List<Event>))
        {
            this.Count = count;
            // to ensure "results" is required (not null)
            this.Results = results ?? throw new ArgumentNullException("results is a required property for InlineResponse2002 and cannot be null");
            this.Next = next;
