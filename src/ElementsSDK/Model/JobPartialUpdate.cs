...
namespace ElementsSDK.Model
{
    ...
    /// JobPartialUpdate
    /// </summary>
    [DataContract(Name = "JobPartialUpdate")]
    public partial class JobPartialUpdate : IEquatable<JobPartialUpdate>
    {
        /// <summary>
        /// Defines InputType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JobPartialUpdate" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JobPartialUpdate {\n");
        ...
        {
            return this.Equals(input as JobPartialUpdate);
        }

        /// <summary>
        /// Returns true if JobPartialUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of JobPartialUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobPartialUpdate input)
        {
            if (input == null)
                return false;
